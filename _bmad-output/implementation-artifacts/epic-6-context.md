...
- **A21 (Eric, 2026-08-16)** — a hull's radar sweep starts at its HEADING. Story 6-1's radar freeze
  ...
  symmetric.
- **A32 (Eric, 2026-08-17)** — queue liveness reaches the home screen through a public `GET
  ...
  both declined.
- **A33 (Eric, 2026-08-17)** — every player-facing liveness count is HUMANS ONLY (bots hold no seat).
...
- **A34 (Eric, 2026-08-17)** — the home screen shows GLOBAL totals only (`PLAYERS ONLINE`,
...
- **A35 (Eric, 2026-08-17)** — `/metrics` is UNTOUCHED. Two routes, and their overlapping numbers are
  MEANT to disagree: process-local is correct for ops, global is correct for players.
- **A36 (Eric, 2026-08-17)** — the mode buttons regain sub-lines (live queue count on SOLO,
...
- **A37 (Eric, 2026-08-17)** — `ArenaRoom.finishCreate` tags its room with `{ mode }` in listing
  metadata. Consistent with A29: that file already knows the word "solo", and `server/src/game/`
  still never does.
- **A38 (Eric, 2026-08-17)** — the honest zero renders. `EXPERIENCE.md:108` ("absence, not
