...
| **BR Chrome Bar** | One restrained mono row, top-center: `12 AFLOAT · 2 KILLS · T+04:12 · RING CLOSES 0:47 · BOUNTY: NAME`. Numbers phosphor, labels muted. Ring readout pulses {colors.amber} at **1 Hz** in the final 10s. The BOUNTY segment (Story 4.6, Eric ruling 2026-08-10) is OPTIONAL — omitted whole, separator included, while the throne is vacant — and is the first segment to carry a PER-PLAYER HUE rather than phosphor/muted/amber. |
