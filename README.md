...
The design history and full plan live in the project's plan file; the visual language is defined in `_bmad-output/planning-artifacts/ux-designs/ux-Hullcracker.io-2026-07-16/DESIGN.md` (root `DESIGN.md` is deprecated).
