...
describe('the radar lattice is pinned beside the protocol version', () => {
  it('radarCellU is 9 at PROTOCOL_VERSION 35 — retune both together, deliberately (PV 34 → 35 was sudden death appending the storm timeline\'s collapse group; the lattice itself did not move)', () => {
