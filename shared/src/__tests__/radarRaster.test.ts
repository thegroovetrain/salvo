...
describe('the radar lattice is pinned beside the protocol version', () => {
  it('radarCellU is 9 at PROTOCOL_VERSION 35 — retune both together, deliberately (PV 34 → 35 was Story 5.6 — the bigger ocean + the self-private Contact.aggro; the lattice itself did not move)', () => {
