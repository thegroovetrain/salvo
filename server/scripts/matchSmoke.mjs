...
function control(ctx, target, armed) {
  const inp = { seq: ++ctx.seq, throttle: 0, rudder: 0, aim: 0, fireSeq: ctx.fireSeq, aimDist: 0, slot: 1, fireT: 0, actSeq: 0, actSlot: 0 };
  if (ctx.you && target) {
...
function idle(ctx) {
  ctx.room.send('i', { seq: ++ctx.seq, throttle: 0, rudder: 0, aim: 0, fireSeq: ctx.fireSeq, aimDist: 0, slot: 1, fireT: 0, actSeq: 0, actSlot: 0 });
}

/** Full-astern + hard-rudder break-off input for a hull pinned on an island. */
function backOff(ctx) {
  return { seq: ++ctx.seq, throttle: -1, rudder: 1, aim: 0, fireSeq: ctx.fireSeq, aimDist: 0, slot: 1, fireT: 0, actSeq: 0, actSlot: 0 };
}
...
function strafeFire(shooter, target, armed) {
  ...
  const inp = { seq: ++shooter.seq, throttle: 1, rudder: 0, aim: 0, fireSeq: shooter.fireSeq, aimDist: 0, slot: 1, fireT: 0, actSeq: 0, actSlot: 0 };
