...
function scriptInput(seq) {
  if (seq === 0) return { seq: 0, throttle: 0, rudder: 0, aim: 0, fireSeq: 0, aimDist: 0, slot: 0, fireT: 0 };
  const rudder = seq % 30 < 15 ? 0.7 : -0.7;
  return { seq, throttle: 1, rudder, aim: 0, fireSeq: 0, aimDist: 0, slot: 0, fireT: 0 };
}
